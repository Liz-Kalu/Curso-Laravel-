...
<header class="bg-white px-6 shadow dark:bg-slate-900">
    ...
    >
        ...
        <div class="-mr-4 flex items-center">
            ...
            {{--sirve para verificar si la página actual corresponde a una ruta específica y, con base en eso, cambiar su apariencia o comportamiento.--}}
            <div class="ml-8 hidden space-x-8 md:flex">
                <a class="px-3 py-2 {{request()->routeIs('home') ? 'text-sky-500':'text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500'}} " href="{{route('home')}}"> Home </a>
                {{--Cuando hagan clic en Home, llévalos a la ruta llamada home.--}}
                <a
                ...
                <a
                    class="px-3 py-2 {{request()->routeIs('nosotros') ? 'text-sky-500':'text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500'}}   "
                    href="{{route('nosotros')}}"
                >
                    About
                </a>
                <a
                    class="px-3 py-2 {{request()->routeIs('contacto') ? 'text-sky-500':'text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500'}} "
                    href="{{route('contacto')}}"
                >
                    Contact
                </a>
...
{{--           <button
    ...
    >
        ...
        <a
            href="{{route('nosotros')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('nosotros') ? 'bg-sky-500 text-white':'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white'}}"
        >
            About
        </a>
        <a
            href="{{route('contacto')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('contacto') ? 'bg-sky-500 text-white':'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white'}}"
        >
            Contact
        </a>
    </div>
