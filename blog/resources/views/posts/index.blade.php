<x-blog-layout :metaTitle="'Blog'" :metaDescription="'Blog description'">
    <div class="mx-auto mt-4 max-w-6xl">
        <h1  class="my-4 mb-8 text-center font-serif text-4xl font-extrabold text-sky-600 md:text-5xl">Blog</h1>
    </div>
    @auth
